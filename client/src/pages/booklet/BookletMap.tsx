  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2]">
      ...
      <div className="max-w-lg mx-auto px-4 pb-24">
        ...
        <div className="mt-4 rounded-xl overflow-hidden bg-muted aspect-square flex items-center justify-center">
          ...
          {chapters.map((chapter: any) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground">Day {chapter.dayNumber}: {chapter.title}</p>
                <p className="text-xs text-muted-foreground">{chapter.location}</p>
              </div>
            </div>
          ))}
        </div>
