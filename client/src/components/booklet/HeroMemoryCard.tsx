      ...
      {heroPhoto ? (
        <div className="relative aspect-[4/3]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4">
            ...
            {caption && (
              <p className="text-white text-lg font-heading leading-snug">
                {caption}
              </p>
            )}
            {tag && (
        ...
        <div className="p-6 min-h-[120px] flex flex-col justify-center">
          ...
          {caption && (
            <p className="text-foreground text-lg font-heading italic leading-snug">
              &ldquo;{caption}&rdquo;
            </p>
          )}
          {tag && (
            <span className="inline-block mt-2 px-2 py-0.5 text-xs font-medium bg-muted text-muted-foreground rounded-full self-start">
              {tag}
            </span>
          )}
        </div>
